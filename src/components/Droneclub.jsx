...
export default function DroneClub() {
    return (
        <section id="droneclub" className="py-16 bg-white">
            <Container className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    {PROGRAMS.map((prog, i) => (
                        ...
                        >
                            {/* Icon placeholder */}
                            <div className="h-12 w-12 flex items-center justify-center rounded-md bg-gradient-to-br from-brand to-brand-light text-white mb-4">
                                <span className="font-bold text-lg">{prog.title[0]}</span>
                            </div>

                            <h3 className="text-xl font-semibold text-brand">{prog.title}</h3>
                            ...
                            <a
                                href="#contact"
                                className="mt-4 inline-block px-4 py-2 rounded-md bg-brand text-white font-semibold hover:bg-brand-light transition-colors duration-300"
                            >
                                Learn More
                            </a>
                        </div>
